...
export const products: Product[] = [
  ...
  {
    id: 'rajasthani-ghee',
    name: 'Mixed Breed Desi Ghee',
    category: 'ghee',
    price: 1350,
    description: 'Our exclusive grass-fed ghee is crafted in small batches using the traditional \'Bilona\' method. We source A2 milk from a mix of native Indian cow breeds like Rathi and Tharparkar, ensuring a pure, nutrient-dense product.',
    image: 'https://placehold.co/600x600.png',
    images: ['https://placehold.co/600x600.png', 'https://placehold.co/600x600.png', 'https://placehold.co/600x600.png'],
    region: 'Rajasthan',
    ingredients: ['A2 Milk from Rathi & Tharparkar cows'],
    farmerStory: {
      name: 'Rani Singh',
      story: 'Our cows are our family. They roam free and graze on native grasses, which makes their milk incredibly nutritious. We churn the curd in clay pots to make ghee the way our grandmothers did, preserving its full-bodied flavor and goodness.',
      video: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
      photo: 'https://placehold.co/300x300.png',
    },
    healthBenefits: ['Strengthens bones', 'Improves brain function', 'Good for heart health', 'Rich in Omega-3 & 9'],
    certifications: ['FSSAI Certified', 'Small-Batch Handcrafted'],
  },
  {
    id: 'millet-cookies',
