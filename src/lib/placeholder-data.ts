...
export const products: Product[] = [
  ...
  {
    id: 'rajasthani-ghee',
    name: 'Small-Batch Desi Ghee',
    category: 'ghee',
    price: 1350,
    description: 'Our exclusive grass-fed ghee is crafted in small batches using the traditional \'Bilona\' method We source A2 milk from native Indian cow breeds like Gir, Sahiwal, Rathi, and Kankrej, ensuring a pure, nutrient-dense, and aromatic product for a limited number of connoisseurs',
    image: 'https://placehold.co/600x600.png',
    images: ['https://placehold.co/600x600.png', 'https://placehold.co/600x600.png', 'https://placehold.co/600x600.png'],
    region: 'Rajasthan',
    ingredients: ['A2 Milk from Gir, Sahiwal, Rathi & Kankrej cows'],
    farmerStory: {
      name: 'Rani Singh',
