        ...
        <div className="grid gap-8 grid-cols-1 md:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <form className="flex gap-2">
                <Input type="email" placeholder="Enter your email" className="flex-1 bg-background placeholder:text-foreground/60 border-primary/20 focus-visible:ring-primary h-11" />
