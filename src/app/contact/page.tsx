...
export default function ContactPage() {
  const whatsappLink = "https://wa.me/918879049091?text=Hello%20Chunks,%20I%20have%20a%20query.";
      ...
      <div className="container mx-auto px-4 md:px-6 py-16">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
             <Card>
              <CardHeader>
                <CardTitle>Speak with our Founder</CardTitle>
                <CardDescription>
                    For any queries, feel free to reach out directly to our founder, Amit Singh.
                </CardDescription>
              </CardHeader>
